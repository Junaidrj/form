...
<div className='h-[77vh] w-[87%] border rounded-full  overflow-hidden ' style={{overflow:"hidden"}}>
        <div className='h-[81%] w-[91%] border  rounded-full ml-[10%] mt-[8%] overflow-hidden'>
        <div className='h-[76%] w-[96%] border  rounded-full ml-[12%] mt-[9%] overflow-hidden'>
        <div className='h-[72%] w-[90%] border rounded-full ml-[13%] mt-[12%] overflow-hidden'>
        </div>
